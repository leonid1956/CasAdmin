...
public class ReportGatewayErrorsPanel extends javax.swing.JPanel {

    public ReportGatewayErrorsPanel() {
        initComponents();
        Date d = new Date();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(casadmin.CasAdminApp.class).getContext().getResourceMap(ReportGatewayErrorsPanel.class);
    ...
    private void tableResultMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableResultMouseClicked
        if (evt.getClickCount() > 1)
        {
            ...
            YPFunctions.showMessage(((String)tableResult.getValueAt(i, 3)).trim() + "\r\n" +
                    ((String)tableResult.getValueAt(i, 4)).trim(), "");
        }
